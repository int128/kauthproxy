...
//go:generate go run go.uber.org/mock/mockgen -destination mock_portforwarder/mock_portforwarder.go github.com/int128/kauthproxy/internal/portforwarder Interface
